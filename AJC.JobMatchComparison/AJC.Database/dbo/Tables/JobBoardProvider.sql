...
GO
CREATE NONCLUSTERED INDEX [IX_JobBoardProvider_IsEnabled]
    ON [dbo].[JobBoardProvider]([IsEnabled] ASC)
    INCLUDE([JobBoardName], [FeedUrl], [CredentialReference], [ExpectedResponseType]) WHERE ([IsEnabled]=(1));
